...
import {
  ...
  getPlaylist,
  addPostToPlaylist,
  removePostToPlaylist,
  viewPostFromPlaylist,
} from "../controllers/playlistControl.js";
import {
  comment,
  createPost,
  deleteComment,
...
router
  .route("/")
  .get(requireLogin, getPost) //get all posts
...
router.get("/findPostwithhashtag", requireLogin, PostWithHashtag);
